...
export class UserService {
  ...
  login(u: User): void {
    this.http.post<User>(`${this.baseUrl}/users/login`, u, {observe: 'response'} /* = to receive the full httpresponse instead of only the body */)
      .subscribe({
        next: (response) => {
  ...
  register(u: User): void {
    this.http.post<User>(`${this.baseUrl}/users`, u, {observe: 'response'})
      .subscribe({
        next: (response) => {
